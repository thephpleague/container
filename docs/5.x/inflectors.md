...
> **DEPRECATED:** Inflectors are deprecated as of v5.2 and will be removed in v6.0. Use `afterResolve()` or the [event system](/5.x/events/) instead.
...
See the [events documentation](/5.x/events/) for the full API.
